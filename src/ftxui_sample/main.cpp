...
// configuration step. It creates a namespace called `vipix`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", vipix::cmake::project_name, vipix::cmake::project_version) };
